...
const AdminOfflineExamPage = () => {
    const router = useRouter();

    const [examTitle, setExamTitle] = useState("");
    const [examCategory, setExamCategory] = useState<number | string>("");
    ...
    useEffect(() => {
        const loadOptions = async () => {
            ...
            const difficulties = await fetchOptions(ENDPOINTS.difficulties);
            setDifficultyOptions(difficulties);
            const categories = await fetchOptions(ENDPOINTS.categories);
...
export default AdminOfflineExamPage;