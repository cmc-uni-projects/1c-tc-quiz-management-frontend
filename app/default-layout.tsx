...
export default function DefaultLayout({
  ...
  return (
    <>
      ...
      <header
        data-global="true"
        className="sticky top-0 z-50 w-full border-b border-zinc-100 bg-white/95 backdrop-blur"
      >
        <div className="mx-auto flex w-full max-w-full items-center justify-between gap-2 px-4 py-3 md:px-6">
          ...
          {/* 3. Nút Hành động */}
          <div className="flex shrink-0 items-center gap-2">{DefaultActions}</div>
        </div>
      </header>
