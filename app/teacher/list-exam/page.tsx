...
interface Exam {
  ...
  title: string;
  description: string;
  categoryName: string; // Assuming the backend provides this
...
export default function ListExamPage() {
  ...
  const handleEdit = (examId: number) => {
    router.push(`/teacher/update-exam/${examId}`);
  };
      ...
      <main className="flex-1 overflow-y-auto px-10 py-8">
        <section className="bg-white rounded-2xl shadow p-8">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-semibold">Danh sách bài thi của tôi</h2>
            <Link href="/teacher/exam-offline" legacyBehavior>
